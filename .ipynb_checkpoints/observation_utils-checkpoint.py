...
def altaz_calc(RADEC, TIME, latitude=52.91, longitude=6.87, save=False):
    ...
    ----------
    RADEC : string
        RA and DEC of pointing, format: "00h00m00s +00d00m00s"
    TIME : numpy.array
    ...
    save : bool, optional
        If True, alt and az arrays will be saved as .txt files instead
        of being returned
        
    Returns
    -------
    altitude : numpy.array, optional
        Pointing altitude for each input mjd time.
    azimuth : numpy.array, optional
        Pointing azimuth for each input mjd time.
